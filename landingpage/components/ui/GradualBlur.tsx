...
export function GradualBlur(props: GradualBlurProps) {
  ...
  const responsiveHeight = useResponsiveDimension(config.responsive, config as unknown as Record<string, unknown>, 'height') || '6rem';
  ...
  const containerStyle = useMemo(() => {
    ...
    const baseStyle: React.CSSProperties = {
      ...
      zIndex: isPageTarget ? (config.zIndex || 10) + 100 : config.zIndex || 10,
      ...config.style,
    };
