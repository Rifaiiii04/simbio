      ...
      <main className="w-full max-w-5xl mx-auto px-6 py-8 sm:py-14 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-xs sm:text-sm md:text-base text-slate-500 font-medium max-w-lg mx-auto">
            Trade Your Expertise, Learn Reciprocally, and Achieve Your Goals Together
          </p>
        </motion.div>
        ...
        {/* 2-Column Split: 50% Form Input (Left: 4 Rows) / 50% Social Sign-In (Right: 4 Rows) */}
        <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-14 items-center relative">
          {/* LEFT 50%: 4 rows (Name, Email, Password, Submit Button) */}
          <motion.form
          ...
          {/* RIGHT 50%: 4 rows (Gmail, Facebook, Apple, Trust badge) */}
          <motion.div
            initial={{ opacity: 0, x: 24 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <button
              type="button"
              onClick={() => showToast('Google sign-up is coming soon. Please use email & password.')}
            ...
            >
              ...
              <span className="truncate">Sign up with Gmail Account</span>
            </button>

            <button
              type="button"
              onClick={() => showToast('Facebook sign-up is coming soon. Please use email & password.')}
              className="w-full h-14 sm:h-[60px] px-6 rounded-full bg-white hover:bg-slate-50 border border-slate-200 text-sm sm:text-base font-semibold text-slate-800 flex items-center gap-3.5 shadow-xs hover:shadow-sm transition cursor-pointer text-left"
            >
              ...
              <span className="truncate">Sign up Facebook Account</span>
            </button>

            <button
              type="button"
              onClick={() => showToast('Apple sign-up is coming soon. Please use email & password.')}
              className="w-full h-14 sm:h-[60px] px-6 rounded-full bg-white hover:bg-slate-50 border border-slate-200 text-sm sm:text-base font-semibold text-slate-800 flex items-center gap-3.5 shadow-xs hover:shadow-sm transition cursor-pointer text-left"
            >
              ...
              <span className="truncate">Sign up Apple Secure ID</span>
            </button>

            {/* 4th Pill: Trust & Privacy Assurance matching identical height */}
            <div className="w-full h-14 sm:h-[60px] px-6 rounded-full bg-slate-50/80 border border-slate-200/80 text-xs sm:text-sm font-medium text-slate-500 flex items-center justify-center gap-2 select-none shadow-2xs">
              <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
              <span>100% Free &amp; Open Reciprocal Community</span>
            </div>
          </motion.div>
        </div>
        ...
        >
          <p className="text-xs sm:text-sm text-slate-600 font-medium">
            ...
            <Link href="/login" className="font-bold text-[#FF6B30] hover:underline underline-offset-4">
